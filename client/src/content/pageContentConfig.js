export const PAGE_CONTENT_CONFIG = {
  ...
  stats: {
    ...
    defaults: {
      ...
      supportsTitle: "Statistiques des supports",
      supportsDescription: "Statistiques des supports",
      supportsSectionTitle: "Statistiques par support",
      supportsSectionDescription: "Statistiques pour chacun des supports",
    },
    fields: {
      ...
      supportsTitle: { label: "Titre: Statistiques supports", type: "text" },
      supportsDescription: { label: "Description: Statistiques supports", type: "textarea" },
      supportsSectionTitle: { label: "Titre section: Par support", type: "text" },
      supportsSectionDescription: { label: "Description section: Par support", type: "textarea" },
    },
  },
  accountingCharges: {
  ...
  layout: {
    ...
    fields: {
      appName: { label: "Nom affiché dans l'en-tête", type: "text" },
      ...
      logoutTooltip: { label: "Icone: Déconnexion", type: "text" },
      settingsTooltip: { label: "Icone: Paramètres", type: "text" },
      guideTooltip: { label: "Icone: Guide", type: "text" },
    },
  },
};
